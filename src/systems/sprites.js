...
export class SpriteSystem {
  ...
  tick(t) {
    for (const sheetType of SHEET_TYPES) {
      ...
      for (let i = 0, il = sprites.length; i < il; i++) {
        ...
        if (isVisible(sprite.el.object3D)) {
          ...
          if (enableSweepingEffectValue) {
            ...
            aSweepParams.setXY(i * 4 + 0, s, t);
            aSweepParams.setXY(i * 4 + 1, s, t);
            aSweepParams.setXY(i * 4 + 2, s, t);
            aSweepParams.setXY(i * 4 + 3, s, t);
          ...
          aMv.array.set(mat4.elements, i * 4 * 16);
          aMv.array.set(mat4.elements, (i * 4 + 1) * 16);
          aMv.array.set(mat4.elements, (i * 4 + 2) * 16);
          aMv.array.set(mat4.elements, (i * 4 + 3) * 16);
        } else {
          aMv.array.set(ZEROS, i * 4 * 16);
        }
      }
